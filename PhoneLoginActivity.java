...
// where the code to let user login using phone number
// need sha 1 to inserted to database to let user login using country code +60
...
//when verification completed successfully
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
         ...
         //provide wrong veriification
            ...
            //will be called after code is send to user
