...
//to display contact list after user accept friend request
...
public class ContactsFragment extends Fragment
{
    ...
    public void onStart()
    {
        ...
        {
            @Override
            protected void onBindViewHolder(@NonNull ContactsViewHolder holder, int position, @NonNull Contacts contacts)
            {
